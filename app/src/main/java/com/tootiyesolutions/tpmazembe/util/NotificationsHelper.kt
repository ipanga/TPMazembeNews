...
import com.tootiyesolutions.tpmazembe.view.MainActivity
...
class NotificationsHelper(val context: Context) {
    ...
    fun createNotification() {
        ...
        val icon = BitmapFactory.decodeResource(context.resources, R.drawable.tp_mazembe_notification)

        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            .setSmallIcon(R.drawable.crocodile_icon)
            .setLargeIcon(icon)
